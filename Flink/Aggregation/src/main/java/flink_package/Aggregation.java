...
public class Aggregation
{
	public static void main(String[] args) throws Exception
	{
		...
		DataStream<String> data = env.readTextFile("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/avg1");
		...
		mapped.keyBy(0).sum(3).writeAsText("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/out1");

		mapped.keyBy(0).min(3).writeAsText("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/out2");

		mapped.keyBy(0).minBy(3).writeAsText("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/out3");

		mapped.keyBy(0).max(3).writeAsText("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/out4");

		mapped.keyBy(0).maxBy(3).writeAsText("/home/vstohniienko/projects/Spark/Flink/Aggregation/data/out5");
		// execute program
