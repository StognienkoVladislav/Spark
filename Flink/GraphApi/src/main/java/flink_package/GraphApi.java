...
public class GraphApi
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		/* format: user, friend */
		DataSet<Tuple2<String, String>> friends = env.readTextFile("/home/vstohniienko/projects/Spark/Flink/GraphApi/data/graph_data")
		...
		fOfUser1.writeAsText("/home/vstohniienko/projects/Spark/Flink/GraphApi/data/result1.txt");
