...
public class Stock_Analysis
{
	public static void main(String[] args) throws Exception
	{
		...
		DataStream<Tuple5<String, String, String, Double, Integer>> data = env.readTextFile("/home/vstohniienko/projects/Spark/Flink/Stock/data/FUTURES_TRADES.txt")
		...
		change.writeAsText("/home/vstohniienko/projects/Spark/Flink/Stock/data/Ist_report.txt");
		...
		largeDelta.writeAsText("/home/vstohniienko/projects/Spark/Flink/Stock/data/Alert.txt");
